...
const menuItems = [
    { title: "Dashboard", iconClass: "uil-home", href: "/provider/dashboard" },
    { title: "My Services", iconClass: "uil-list", href: "/provider/services" },
    { title: "Bookings", iconClass: "uil-clipboard-alt", href: "/provider/bookings" },
